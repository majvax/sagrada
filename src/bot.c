...
void simulate_game(board* bot_board, board* opp_board, die** dice_set, int rounds_remaining, int priority) {
...
int make_move(board* b, die** dice, board* opponent_board, die** dice_set, int rounds_remaining, int priority) {
